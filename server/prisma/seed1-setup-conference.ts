...
import { Role, ConferenceStatus, SectionType } from "@prisma/client";
...
async function main() {
  ...
  let organizers = await prisma.user.findMany({
    where: { roles: { has: Role.organizer } },
    take: 3,
  });
    ...
    for (let i = organizers.length; i < 3; i++) {
      const organizer = await prisma.user.create({
        data: {
          ...
          jobTitle: ["Professor of AI", "Research Director", "Department Head"][
            i
          ],
        },
      });
  ...
  const conferenceTemplates = [
    {
      name: "International Conference on Machine Learning Applications 2025",
      description: `ICMLA 2025 brings together researchers and practitioners to discuss the latest advances in machine learning applications across various domains.
...
Submit your original research, case studies, and innovative applications. We welcome both theoretical contributions and practical implementations.`,
      ...
      websiteUrl: "https://icmla2025.conference.org",
      categories: [
        {
          name: "Deep Learning",
        ...
        },
        {
          ...
          description: "Image processing, object detection, visual recognition",
        },
        {
        ...
        },
        {
          ...
          description: "Agent-based learning, policy optimization",
        },
        {
          name: "AI Ethics",
          description: "Fairness, bias, responsible AI development",
        },
      ],
      presentationTypes: [
        {
          name: "Full Paper Presentation",
          description: "Complete research paper presentation",
          defaultDuration: 20,
          minDuration: 18,
          maxDuration: 25,
        },
        {
          ...
          description: "Work-in-progress or preliminary results",
          defaultDuration: 15,
          minDuration: 12,
          maxDuration: 18,
        },
        {
          name: "Poster Session",
          description: "Visual presentation with discussion",
          defaultDuration: 90,
          minDuration: 60,
          maxDuration: 120,
        },
        {
          name: "Demo Session",
          description: "Live demonstration of systems",
          defaultDuration: 10,
          minDuration: 8,
          maxDuration: 15,
        },
      ...
      submissionSettings: {
        submissionDeadline: new Date("2025-07-01T23:59:59Z"),
        ...
        submissionGuidelines:
          "Papers should be 6-12 pages in IEEE format. Include experimental results and comparison with existing methods.",
        authorGuidelines:
          "All authors must be listed with full affiliations. At least one author must register for the conference.",
        reviewCriteria:
          "Technical quality, novelty, experimental validation, and clarity of presentation.",
      },
    },

    {
      name: "International Symposium on Cybersecurity and Privacy 2025",
      description: `ISCP 2025 focuses on cutting-edge research in cybersecurity, privacy protection, and digital forensics.
...
We invite researchers, practitioners, and graduate students to submit their latest findings and innovative solutions.`,
      ...
      registrationDeadline: new Date("2025-09-20T23:59:59Z"),
      websiteUrl: "https://iscp2025.security.org",
      categories: [
        {
          name: "Network Security",
          description: "Firewalls, IDS/IPS, network protocols security",
        },
        {
          name: "Cryptography",
          description:
            "Encryption algorithms, key management, quantum cryptography",
        },
        {
          name: "Blockchain & DLT",
          description: "Distributed ledger technologies, smart contracts",
        },
        {
          name: "Privacy Technologies",
          description: "Data anonymization, differential privacy",
        },
        {
          name: "Digital Forensics",
          description: "Evidence collection, analysis techniques",
        },
        {
          name: "IoT Security",
          description: "Internet of Things security challenges",
        },
      ],
      presentationTypes: [
        {
        ...
        {
          name: "Industry Track",
          description: "Practical industry experiences",
          defaultDuration: 20,
          minDuration: 15,
          maxDuration: 25,
        },
        ...
        },
        {
          ...
          description: "Expert panel on trending topics",
          defaultDuration: 60,
          minDuration: 45,
          maxDuration: 90,
        },
      ...
      submissionSettings: {
        submissionDeadline: new Date("2025-08-10T23:59:59Z"),
        ...
        submissionGuidelines:
          "Submissions must be original work not published elsewhere. Use ACM format for all submissions.",
        authorGuidelines:
          "Include complete author information and conflict of interest statements.",
        reviewCriteria:
          "Originality, technical soundness, practical significance, and presentation quality.",
      },
    },

    {
      name: "International Conference on Sustainable Computing 2025",
      description: `ICSC 2025 explores the intersection of computing technologies and environmental sustainability.
...
Join researchers, industry leaders, and policymakers in addressing computing's environmental challenges.`,
      ...
      registrationDeadline: new Date("2025-10-12T23:59:59Z"),
      websiteUrl: "https://icsc2025.greentech.org",
      categories: [
        {
          name: "Green Computing",
          description: "Energy-efficient computing systems and algorithms",
        },
        {
          name: "Sustainable Software",
          description: "Software engineering for sustainability",
        },
        {
          name: "Data Center Efficiency",
          description: "Optimizing data center operations",
        },
        {
        ...
        },
        {
          ...
          description: "Environmental policies for computing",
        },
      ],
      presentationTypes: [
        {
          name: "Technical Paper",
          description: "Technical research presentation",
          defaultDuration: 18,
          minDuration: 15,
          maxDuration: 22,
        },
        {
          name: "Position Paper",
          description: "Vision and position statements",
          defaultDuration: 12,
          minDuration: 10,
          maxDuration: 15,
        },
        ...
        {
          name: "Lightning Talk",
          description: "Quick presentation of ideas",
          defaultDuration: 5,
          minDuration: 3,
          maxDuration: 8,
        },
      ...
      submissionSettings: {
        submissionDeadline: new Date("2025-08-25T23:59:59Z"),
        allowLateSubmissions: true,
        requireAbstract: true,
        ...
        allowDurationRequest: true,
        submissionGuidelines:
          "Extended abstracts (4-6 pages) are acceptable. Focus on environmental impact and sustainability metrics.",
        authorGuidelines:
          "Encourage submissions from industry practitioners and policy makers.",
        reviewCriteria:
          "Environmental relevance, innovation, feasibility, and potential impact.",
      },
    },

    {
      name: "Workshop on Human-Computer Interaction in Healthcare 2025",
      description: `HCIH 2025 brings together HCI researchers and healthcare professionals to explore innovative interfaces and technologies.
...
Submit your research on improving healthcare through better technology design.`,
      ...
      startDate: new Date("2025-08-08T09:00:00Z"),
      endDate: new Date("2025-08-09T17:00:00Z"),
      registrationDeadline: new Date("2025-07-20T23:59:59Z"),
      websiteUrl: "https://hcih2025.healthtech.ca",
      categories: [
        {
          name: "Medical Interfaces",
          description: "User interfaces for medical devices and systems",
        },
        {
          name: "Patient Experience",
          description: "Patient-centered design and usability",
        },
        {
          name: "Clinical Workflows",
          description: "Technology integration in clinical settings",
        },
        {
          name: "Accessibility",
          description: "Inclusive design for diverse populations",
        },
        {
          name: "Data Visualization",
          description: "Health data presentation and interpretation",
        },
      ],
      presentationTypes: [
        {
          name: "Work-in-Progress",
          description: "Ongoing research presentation",
          defaultDuration: 10,
          minDuration: 8,
          maxDuration: 12,
        },
        {
          ...
          description: "Design process and outcomes",
          defaultDuration: 15,
          minDuration: 12,
          maxDuration: 18,
        },
        {
          name: "Demo Session",
          description: "Interactive system demonstration",
          defaultDuration: 20,
          minDuration: 15,
          maxDuration: 25,
        },
        {
          ...
          description: "Viewpoint or opinion presentation",
          defaultDuration: 8,
          minDuration: 5,
          maxDuration: 10,
        },
      ...
      submissionSettings: {
        submissionDeadline: new Date("2025-06-15T23:59:59Z"),
        allowLateSubmissions: true,
        requireAbstract: true,
        ...
        allowDurationRequest: false,
        submissionGuidelines:
          "Short papers (2-4 pages) preferred. Include user study results or design rationale.",
        authorGuidelines:
          "Multidisciplinary teams encouraged. Include healthcare professional perspectives.",
        reviewCriteria:
          "Healthcare relevance, user-centered approach, design quality, and evaluation rigor.",
      },
    },

    {
      name: "International Conference on Educational Technology and Learning Analytics 2025",
      description: `ICETLA 2025 explores the transformative role of technology in education and learning sciences.
...
We welcome educators, technologists, and researchers to share innovations in educational technology.`,
      ...
      registrationDeadline: new Date("2025-11-05T23:59:59Z"),
      websiteUrl: "https://icetla2025.edtech.edu.au",
      categories: [
        {
          name: "Learning Analytics",
          description: "Data-driven insights into learning processes",
        },
        {
          name: "Adaptive Systems",
          description: "Personalized learning technologies",
        },
        {
        ...
        {
          name: "AI Tutoring",
          description: "Intelligent tutoring and assessment systems",
        },
        {
          name: "Educational Games",
          description: "Gamification and serious games",
        },
        {
          name: "Accessibility",
          description: "Inclusive educational technologies",
        },
      ],
      presentationTypes: [
        {
        ...
        },
        {
          ...
          description: "Implementation experiences",
          defaultDuration: 15,
          minDuration: 12,
          maxDuration: 18,
        },
        {
          ...
          description: "Educational technology demonstration",
          defaultDuration: 25,
          minDuration: 20,
          maxDuration: 30,
        },
      ...
      submissionSettings: {
        submissionDeadline: new Date("2025-09-01T23:59:59Z"),
        allowLateSubmissions: false,
        requireAbstract: true,
        ...
        allowDurationRequest: true,
        submissionGuidelines:
          "Include pedagogical theory, system description, and evaluation results. Papers should be 8-15 pages.",
        authorGuidelines:
          "Encourage collaboration between educators and technologists.",
        reviewCriteria:
          "Educational impact, technical innovation, evaluation methodology, and scalability.",
      },
    },
  ];

  console.log(
    `🏛️ Creating ${conferenceTemplates.length} call-for-papers conferences...`
  );
  ...
  for (let i = 0; i < conferenceTemplates.length; i++) {
    ...
    await prisma.section.create({
      data: {
        ...
        startTime: new Date(
          template.startDate.getTime() + 2 * 60 * 60 * 1000
        ), // 2 hours after start
        endTime: new Date(
          template.startDate.getTime() + 5 * 60 * 60 * 1000
        ), // 5 hours after start
        room: "Main Hall",
        capacity: template.capacity,
