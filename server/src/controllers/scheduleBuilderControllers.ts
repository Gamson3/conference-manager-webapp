...
//     // Build where clause for unassigned presentations
//     let whereClause: any = {
//       // Get presentations from sections that belong to this conference
//       section: {
//         conferenceId: Number(conferenceId)
//       },
//       // But are not yet assigned to a specific section (for scheduling)
//       OR: [
//         { sectionId: null },
//         { timeSlot: null }
//       ],
//       reviewStatus: 'APPROVED' // Only show approved presentations
//     };
...
//         };
//       }
//       acc[categoryName].presentations.push(presentation);
//       return acc;
//     }, {});

//     res.json({
//       total: presentations.length,
//       grouped: groupedPresentations,
//       flat: presentations
//     });
...
//     res.json({
//       conference: scheduleData,
//       statistics: {
//         totalPresentations,
//         assignedPresentations,
//         unassignedPresentations: totalPresentations - assignedPresentations,
//         approvedPresentations,
//         assignmentPercentage: totalPresentations > 0 ? Math.round((assignedPresentations / totalPresentations) * 100) : 0
//       }
//     });

//   } catch (error: any) {
//     console.error("Error fetching schedule overview:", error);
//     res.status(500).json({ message: "Failed to fetch schedule overview", error: error.message });
//   }
// };
