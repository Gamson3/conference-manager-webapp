...
// export const getConferenceSchedule = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const { id } = req.params;
//     const userId = getUserId(req);

//     console.log(`[DEBUG] Getting schedule for conference ${id}, user ${userId}`);

//     // Get conference with basic info
...
//     console.log(`[DEBUG] Fetching schedule data for conference ${id}`);

//     // Get the hierarchical schedule structure - only scheduled presentations
...
//             presentations: {
//               where: {
//                 sectionId: { not: null } // ✅ Only presentations assigned to sections
//               },
//               include: {
//                 authors: {
//                   orderBy: { order: 'asc' },
...
//                 presentations: {
//                   where: {
//                     sectionId: { not: null } // ✅ Only count scheduled presentations
//                   }
//                 },
//                 attendees: true 
//               }
...
//     console.log(`[DEBUG] Found ${days.length} days for conference ${id}`);
...
//               order: author.order,
//               title: author.title,
//               bio: author.bio || author.internalUser?.bio,
...
//     console.log(`[DEBUG] Sending schedule response for conference ${id}`);
...
// export const getConferencePresentations = async (req: Request, res: Response): Promise<void> => {
//   try {
//     const { id } = req.params;
//     const userId = getUserId(req);
...
//     const canView = isAdmin(req) || 
//                    conference.createdById === userId || 
//                    (conference.status === 'published' && conference.isPublic);
...
//     // Get all scheduled presentations for this conference
//     const presentations = await prisma.presentation.findMany({
//       where: {
//         conferenceId: Number(id), // ✅ Direct conference relation
