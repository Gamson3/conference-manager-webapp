...
const CREATION_STEPS = [
	...
	{ id: 2, path: 'categories', title: 'Categories & Types', description: 'Define presentation categories', icon: Tag },
	{ id: 3, path: 'publish', title: 'Publish Settings', description: 'Configure submission settings', icon: Globe },
];
		...
		<Card className="mb-8 border-blue-200 bg-blue-50">
			<CardHeader className="pb-4">
				<div className="flex items-center justify-between">
					...
					{showCancelButton && (
						<CancelButton fallbackPath="/organizer/events" size="sm">
							Cancel Setup
						</CancelButton>
					)}
				</div>
